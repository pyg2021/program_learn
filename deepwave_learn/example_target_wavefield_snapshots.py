...
import torchvision
import deepwave
from deepwave.common import cfl_condition
...
(source_amplitudes.detach().cpu().numpy()
 .tofile('deepwave_learn/result2/source_amplitudes.bin'))
...
for i in range(nt):
    ...
    torchvision.utils.save_image(val, f'deepwave_learn/result2/wavefield_{i:03d}.jpg')