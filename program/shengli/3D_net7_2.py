...
x_2,y_2=DataLoad(5000+100,5000+119)
x_3,y_3=DataLoad(10000+100,10000+119)
x=np.concatenate((x_1,x_2,x_3),axis=0)
y=np.concatenate((y_1,y_2,y_3),axis=0)
...
for epoch_i in range(epoch):
    ...
    if epoch_i%50==0 and epoch_i>=40:
        ...
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/v_updata7_2.png")
        plt.close()
        sio.savemat("/home/pengyaoguang/data/3D_net_result/v_updata6.mat",{"v":model(x).cpu().detach()[0,0]})
        torch.save(model.state_dict(),"/home/pengyaoguang/data/3D_net_model/modeltest7_2.pkl")

        plt.figure()
        plt.imshow(y.cpu().detach()[0,0,50,:,:].T)
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/v_real7_2.png")
        plt.close()
        ...
        plt.ylabel("loss")
        plt.legend()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/history7_2.png")
        plt.close()
