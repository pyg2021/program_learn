...
model.load_state_dict(torch.load("/home/pengyaoguang/data/3D_net_model/modeltest9_0.pkl"))

<<<<<<< HEAD
for k in range(5000,5000+30):
    #10012_20
    #10_50
    m=5
    ##data_prepare
    ...
    if loss>0.5:
        print('k:',k,111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111)
=======
...
plt.colorbar()
plt.savefig("/home/pengyaoguang/data/3D_net_result/v_error{}.png".format(m))
>>>>>>> b12289973a10c9afdb84a2aaf4506e643e8b7f76
