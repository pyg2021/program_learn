...
for epoch_i in range(epoch):
    ...
    if epoch_i%50==0 and epoch_i>=40:
        ...
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/v_updata6.png")
        plt.close()
        sio.savemat("/home/pengyaoguang/data/3D_net_result/v_updata6.mat",{"v":model(x).cpu().detach()[0,0]})
        torch.save(model.state_dict(),"/home/pengyaoguang/data/3D_net_model/modeltest6.pkl")

        plt.figure()
        plt.imshow(y.cpu().detach()[0,0,50,:,:].T)
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/v_real6.png")
        plt.close()
        ...
        plt.ylabel("loss")
        plt.legend()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/history6.png")
        plt.close()
