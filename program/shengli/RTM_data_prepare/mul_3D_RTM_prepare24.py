...
for j in range(98,108):
    ...
    shape = (100 ,100 ,100 )
    v=sio.loadmat("/home/yaoguang/data/3D_RTM2/v{}.mat".format(j))['v']
    sample=1
    ...
    src_coordinates[0, -1] = 1.  # Depth is 20m
    ...
    rec_coordinates[:, 0] = np.repeat(np.linspace(0, model.domain_size[0], num=40), 40)
    rec_coordinates[:, 1] = np.tile(np.linspace(20, model.domain_size[1], num=40), 40)
    ...
    for i in range(nshots):
        ...
        print(end-start,"s")
        #NBVAL_IGNORE_OUTPUT
    sio.savemat("/home/yaoguang/data/3D_RTM2/RTM{}.mat".format(j+1),{"RTM":image.data})
