...
# v=sio.loadmat("/home/pengyaoguang/data/3D_v/v0.mat")['v']
v=sio.loadmat("/home/pengyaoguang/data/3D_v/Overthrust_vel0.mat")['v']/1000
...
for i in range(nshots):
    ...
    print(end-start,"s")
    #NBVAL_IGNORE_OUTPUT
    sio.savemat("/home/pengyaoguang/data/3D_RTM/overtrust_RTM.mat",{"RTM":image.data})
