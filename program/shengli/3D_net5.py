...
for epoch_i in range(epoch):
    ...
    if epoch_i%50==0:
        ...
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/v_updata5.png")
        plt.close()
        sio.savemat("/home/pengyaoguang/data/3D_net_result/v_updata5.mat",{"v":model(x).cpu().detach()[0,0]})
        torch.save(model.state_dict(),"/home/pengyaoguang/data/3D_net_model/modeltest5.pkl")
        ...
        plt.ylabel("loss")
        plt.legend()
        plt.savefig("/home/pengyaoguang/data/3D_net_result/history5.png")
        plt.close()
