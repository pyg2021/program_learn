...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/start_4.png")
plt.close()
v = v_init.clone()
v.requires_grad_()
...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/true_4.png")
plt.close()
...
for epoch in range(n_epochs):
    ...
    if epoch%10==0:
        ...
        plt.colorbar()
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/update_4.png".format(epoch))
