...
for i in range(num_cols*num_rows):
    ...
    if i==0:
        ...
        plt.title('x = 0.05 km',fontsize=16)
        ax1.invert_yaxis()
        
        ax1.set_ylabel('Depth (km)',fontsize=14)
        plt.yticks(np.arange(0,hgrid,step=20),['0','0.2','0.4','0.6','0.8'],fontsize=14)
    ...
    if i==1:
        ...
        ax1.invert_yaxis()
        plt.title('x = 0.5 km',fontsize=16)
    ...
    if i==2:
        ...
        ax1.invert_yaxis()
        plt.title('x = 0.92 km',fontsize=16)
