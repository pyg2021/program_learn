...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/start_1.png")
plt.close()
v = v_init.clone()
v.requires_grad_()
...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/true_1.png")
plt.close()
...
optimiser = torch.optim.AdamW([v], lr=0.001)
...
for epoch in range(n_epochs):
    ...
    if epoch%100==0:
        ...
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/update_1.png".format(epoch))
        plt.close()

        plt.figure()
        plt.plot(range(len(res)),res)
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/hi_1.png".format(epoch))
        plt.close()
