...
dx = 10.0
k=30002
v=sio.loadmat("/home/pengyaoguang/data/3D_v_model/v{}".format(k))["v"][50]*1000
plt.imshow(v.T)
plt.savefig('/home/pengyaoguang/program_learn/program/2D/2d_Rtm_data/1.jpg')
...
plt.tight_layout()
plt.savefig('/home/pengyaoguang/program_learn/program/2D/2d_Rtm_data/example_forward_model.jpg')
...
plt.tight_layout()
plt.savefig('/home/pengyaoguang/program_learn/program/2D/2d_Rtm_data/example_rtm_mask.jpg')
...
plt.imshow(scatter.detach().cpu().T, aspect='auto', cmap='gray',
           vmin=vmin, vmax=vmax)
plt.savefig('/home/pengyaoguang/program_learn/program/2D/2d_Rtm_data/example_rtm.jpg')

scatter.detach().cpu().numpy().tofile('/home/pengyaoguang/program_learn/program/2D/2d_Rtm_data/marmousi_scatter.bin')
end=time.time()
