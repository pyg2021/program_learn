...
# model=torch.load("/home/pengyaoguang/data/2D_data/2D_result/modeltest9_50.pkl")
...
model=torch.load("/home/pengyaoguang/data/2D_data/2D_result/modeltest9_57.pkl")
...
# k=1
k=201
overthrust_data=np.ones((100,100,100))
smooth=np.ones((100,100,100))
real=np.ones((100,100,100))
for j in range(100):
    # j=80
    print(j)
    save=False  
    ...
    l2=loss_2(g,label1)
    overthrust_data[j]=y_1.detach().cpu()[0,0]
    ...
    # break
# sio.savemat('/home/pengyaoguang/data/3D_fuse/3D_overthrust_fuse.mat',{'v':overthrust_data/1000})
# sio.savemat('/home/pengyaoguang/data/3D_fuse/3D_seam_fuse.mat',{'v':overthrust_data/1000})

sio.savemat('/home/pengyaoguang/data/3D_fuse/{}_v_updete_test.mat'.format(k),{'v':overthrust_data/1000})
sio.savemat('/home/pengyaoguang/data/3D_fuse/{}_v_real_test.mat'.format(k),{'v':real/1000})
sio.savemat('/home/pengyaoguang/data/3D_fuse/{}_v_smooth_test.mat'.format(k),{'v':smooth/1000})
