...
model.load_state_dict(torch.load("/home/pengyaoguang/data/2D_data/2D_result/modeltest9_62.pkl"))
...
train(model,train_loader_1,test_loader_1,10000,device,optimizer,scheduler,loss_1,save_number=62)
# test(model,train_loader_1,loss_1,device)
# test(model,train_loader_2,loss_1,device)
