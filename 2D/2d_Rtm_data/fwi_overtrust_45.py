...
v_init = (torch.tensor(1/gaussian_filter(1/v_true.numpy(), 30))
          .to(device))
v = v_init.clone()
v.requires_grad_()
...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/4.png")
plt.close()
...
for epoch in range(n_epochs):
    ...
    if epoch%100==0:
        ...
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/5.png".format(epoch))
        plt.close()
