#针对于三维的数据，通过200个overtrust数据的井数据得到微调后的结果（相对于16增加了数据的数量到400）
import torch
...
train(model,train_loader_1,test_loader_1,10000,device,optimizer,scheduler,loss_1,save_number=22)
# test(model,train_loader_1,loss_1,device)
# test(model,train_loader_2,loss_1,device)
