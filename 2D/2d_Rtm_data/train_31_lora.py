#针对于三维的数据，通过将overtrust数据的井数据得到微调后的结果（并改变了对encodeing参数的学习率）、增加大数据块，数据量大小450（仅用大块）
import torch
...
# x_2,y_2=DataLoad3(28,59)
# x_3,y_3=DataLoad3(109,117)
# x=np.concatenate((x_1,x_2,x_3),axis=0)
# y=np.concatenate((y_1,y_2,y_3),axis=0)
x,y=DataLoad3(109,117)
x=x[::2]
y=y[::2]
...
# loss_1=torch.nn.L1Loss()
loss_1=torch.nn.MSELoss()
train(model,train_loader_1,test_loader_1,10000,device,optimizer,scheduler,loss_1,save_number=31)
# test(model,train_loader_1,loss_1,device)
# test(model,train_loader_2,loss_1,device)
