...
# all_data=sio.loadmat('/home/pengyaoguang/data/3D_fuse/{}_v_FWI.mat'.format(k))['v']
# for i in range(51,100):
#     all_data[i]=all_data[i]*1000
# sio.savemat('/home/pengyaoguang/data/3D_fuse/{}_v_FWI.mat'.format(k),{'v':all_data})
