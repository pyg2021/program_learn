...
# for k in range(25100,25300):
    ...
    # plt.imshow(v.T)
    # plt.colorbar()
    # plt.savefig('/home/pengyaoguang/data/2D_data/2D_v_model1209/v{}.jpg'.format(k))
    ...
    # v.detach().cpu().numpy().tofile('/home/pengyaoguang/data/2D_data/2D_v_model/v{}.bin'.format(k))
    n_shots = 45
    ...
    #         vmin=vmin, vmax=vmax)
    # plt.savefig('/home/pengyaoguang/data/2D_data/2D_RTM1209/rtm{}.jpg'.format(k))

    scatter.detach().cpu().numpy().tofile('/home/pengyaoguang/data/2D_data/2D_RTM1209/RTM{}.bin'.format(k))
    end=time.time()
    print('{}'.format(k),'finish:',end-start,'s')
    # break