...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/start.png")
plt.close()
v = v_init.clone()
v.requires_grad_()
...
plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/true.png")
plt.close()
...
for epoch in range(n_epochs):
    ...
    if epoch%100==0:
        ...
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/update.png".format(epoch))
        plt.close()

        plt.figure()
        plt.plot(range(len(res)),res)
        plt.savefig("/home/pengyaoguang/program_learn/2D/2d_Rtm_data/fwi/hi.png".format(epoch))
        plt.close()
