...
def DataLoad(a,b):
    ...
    for k in range(a,b+1):
        R=sio.loadmat("/home/pengyaoguang/data/3D_RTM2/RTM{}".format(k))["RTM"][20:120,20:120,20:120]
        label=sio.loadmat("/home/pengyaoguang/data/3D_RTM2/v{}".format(k-1))["v"]*1000
